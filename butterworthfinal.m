...
fr54=fr5-fr4;
toc
figure('NumberTitle', 'off', 'Name', 'Y通道频谱巴特沃斯滤波演示图');
...
%     K5 = imlincomb(0.5,k4,0.5,RGB_5);
 RGB_0=imlincomb(1,RGB_0,1,RGB_1,1,RGB_2,1,RGB_3,1,RGB_4,0.5,RGB_5);%I,J是读入的两幅图像
 RGB_01=imlincomb(1,RGB_0,0.8,RGB_1,0.6,RGB_2,0.4,RGB_3,0.2,RGB_4,0.1,RGB_5);
   RGB_012=imlincomb(1,RGB_0,0.9,RGB_1,0.8,RGB_2,0.7,RGB_3,0.6,RGB_4,0.5,RGB_5);
...
RGB_01234=imlincomb(1,RGB_0,1,RGB_1,1,RGB_2,1,RGB_3,1,RGB_4,1,RGB_5);
 ...
 subplot(231),imshow(RGB_0,[])  ,title('YUV2RGB');
