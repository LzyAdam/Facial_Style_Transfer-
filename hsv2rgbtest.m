...
fr54=fr5-fr4;
image=1*fr0+0.9*fr10+0.7*fr21+0.6*fr32+fr43+fr54;
figure('NumberTitle', 'off', 'Name', '巴特沃斯滤波器');
...
%        S=abs( RGB_012345)+1;    %取模并进行缩放
 figure('NumberTitle', 'off', 'Name', '6=>HSV还原RGB处理后图像');
...
%  G1=sqrt(P1/(P7+0.001));G2=sqrt(P2/(P8+0.001));G3=sqrt(P3/(P9+0.001));
%   G4=sqrt(P4/(P10+0.001));G5=sqrt(P5/(P11+0.001));G6=sqrt(P6/(P12+0.001));
%   RGB_06=imadd(0.9*RGB_0,0.22*RGB_6);
%   RGB_17=imadd(0.8*RGB_1,0.2*RGB_7);
%   RGB_28=imadd(0.7*RGB_2,0.3*RGB_8);
%   RGB_39=imadd(0.6*RGB_3,0.4*RGB_9);
%   RGB_410=imadd(0.5*RGB_4,0.5*RGB_10);
%   RGB_511=imadd(0.5*RGB_5,0.6*RGB_11);
%   figure('NumberTitle', 'off', 'Name', '13=>=>迁移风格后图像');
% %   imshow(RGB_06);
% %    figure('NumberTitle', 'off', 'Name', '12=>=>HSV还原RGB不同6频段滤波器样子及处理后图像');
...
%   figure('NumberTitle', 'off', 'Name', '14=>=>迁移风格后图像复合成像');
...
%   RGB_R=imlincomb(1,RGB_06, 2,RGB_17, 5,RGB_28,4,RGB_39,2,RGB_410,1,RGB_511);
%     RGB_T=imlincomb(1,RGB_06, 5,RGB_17, 2,RGB_28,3,RGB_39,52,RGB_410,9,RGB_511);
%       RGB_Y=imlincomb(1,RGB_06, 9,RGB_17, 4,RGB_28,3,RGB_39,2,RGB_410,1,RGB_511);
%   %D0=10;D1=20;   D2=40;D3=60;  D4=80;D5=255;     
%    subplot(231),imshow(RGB_Q,[])  ,title('RGB06');
%  subplot(232),imshow(RGB_W,[])  ,title('RGBI=>1:0.9:0.8:0.7:0.6:0.5');
...
%  subplot(232),imshow(RGB_I,[])  ,title('RGBI=>1:933333');
