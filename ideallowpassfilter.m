...
figure('NumberTitle', 'off', 'Name', '理想低通滤波器');
imshow(image,[]);title('最终效果');%%D0=10;滤波器处理过的
% toc
...
% figure('NumberTitle', 'off', 'Name', '理想低通滤波演示图');
% 
% subplot(2,3,1);imshow(T0);title('低通滤波器D0=10');
% 
% subplot(232);imshow(T1-T0),title('低通滤波器D1=20 D1-D0');
% 
% subplot(233);imshow(T2-T1);title('低通滤波器D2=40 D2-D1');
% 
% subplot(234);imshow(T3-T2),title('低通滤波器D3=60 D3-D2');
% subplot(235);imshow(T4-T3),title('低通滤波器D4=60 D4-D3 ');
% subplot(236);imshow(T5-T4),title('低通滤波器D5=255 D5-D4');
% % 
% % % 
% % % 
