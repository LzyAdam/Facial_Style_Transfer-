...
figure
subplot(3,4,1);imshow(R0,[]);title('D0=10的效果图');
subplot(3,4,2);imshow(T0);title('低通滤波器D0=10');
subplot(3,4,3);imshow(R1,[]);title('D1=20的效果图');
subplot(3,4,4);imshow(T1),title('低通滤波器D1=20');
subplot(3,4,5);imshow(R2,[]);title('D2=40的效果图');
subplot(3,4,6);imshow(T2);title('低通滤波器D2=40');
subplot(3,4,7);imshow(R3,[]);title('D3=80的效果图');
subplot(3,4,8);imshow(T3),title('低通滤波器D3=80');
subplot(3,4,9);imshow(R4,[]);title('D4=160的效果图');
subplot(3,4,10);imshow(T4),title('低通滤波器D4=160');
subplot(3,4,11);imshow(R5,[]);title('D5=80的效果图');
subplot(3,4,12);imshow(T5),title('低通滤波器D3=250');
